...
- **Branching Policy**: Follow the branch-first development workflow and `<github-username>/<parent-branch>/<feature>` naming convention described in [BRANCHING.md](BRANCHING.md).
...
- **Branches & PRs**: Create a feature branch following [BRANCHING.md](BRANCHING.md) and open Pull Requests targeting **`main`** only (never `dev`) using the [PR template](.github/PULL_REQUEST_TEMPLATE.md).
