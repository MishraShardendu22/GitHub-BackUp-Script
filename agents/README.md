...
| :--- | :--- | :--- |
| **Branch Management** | [`skills/git-branch-management/`](skills/git-branch-management/SKILL.md) | Branch creation policy, hierarchical naming (`<github-username>/<parent-branch>/<change>`), and lifecycle rules. |
