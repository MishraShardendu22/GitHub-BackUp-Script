...
-- 6. Normalize backup_results: extract error_message into backup_result_errors
...
-- 7. Normalize backup_fixes: extract commit_hash into backup_fix_commits
...
-- 11. Normalize embedding_jobs: extract error_message into embedding_job_errors
